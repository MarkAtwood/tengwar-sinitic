...
| xué wú zhǐ jìng | 学无止境 | learning has no limits |  | `{harma}{+pal}{vala}[e]²{vala}[u]²{calma}[i]³{quesse}{+pal}[i]{noldo}⁴` |
| rén shān rén hǎi | 人山人海 | huge crowds |  | `{oore}[e]{nuumen}²{hwesta}[a]{nuumen}¹{oore}[e]{nuumen}²{harma}[a]³` |
| fēng hé rì lì | 风和日丽 | gentle breeze, beautiful day |  | `{formen}[e]{noldo}¹{harma}[e]²{oore}[i]⁴{lambe}[i]⁴` |
| lóng fēi fèng wǔ | 龙飞凤舞 | lively and vigorous (calligraphy) |  | `{lambe}[o]{noldo}²{formen}[e]¹{formen}[e]{noldo}⁴{vala}[u]³` |

## Rendered

![chengyu](svg/chengyu.svg)
